...
async function validateLink(sourceFile: string, link: string): Promise<string | null> {
...
async function main(): Promise<void> {
  const markdownFiles = (await Promise.all(markdownRoots.map(collectMarkdownFiles))).flat();
